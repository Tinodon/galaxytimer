...
export function helpText() {
  ...
  lines.push(
    ...
    '`/map <alliance> [HQ]` — the same for every member. Add an HQ level to see',
    'only those bases: `/map folk valley 5` — who to hit in a war.',
    '`/who <coords>` — who is there: `/who coords:359,11`.',
    '`/list [page or name]` — players on the map, A to Z. ⚠️ = more than they own.',
    '`/pin <player> <coords> [HQ]` ... — add planets, several players at once:',
    '`/pin John 512,340 5 Mike 601,299`.',
    '`/pingl <coords> <player> [HQ]` ... — one galaxy, its players in a row:',
    '`/pingl 359,11 John 5 Mike 7`.',
